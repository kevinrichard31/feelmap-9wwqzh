...
const allowedOrigins = ['https://launch.feelmap-app.com', 'http://localhost:5173', 'file://', 'http://localhost']; // Liste des origines autorisées
...
app.use(cors({
  origin: ['https://launch.feelmap-app.com', 'http://localhost:5173', 'https://www.launch.feelmap-app.com', 'launch.feelmap-app.com', 'file://', 'http://localhost'], // Domaines autorisés
